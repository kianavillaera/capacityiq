...
from src.mappings import normalise_name, normalise_uid, build_user_mapping
...
class TestBuildUserMapping:
    ...
    def test_exact_match_auto_accepted(self):
        mapping = build_user_mapping(
            self._make_replicon_users(), self._make_sn_users()
        )
    ...
    def test_returns_expected_columns(self):
        ...
        expected = {
            "replicon_username", "servicenow_user_id", "match_method",
            "final_score", "match_status", "review_required",
        }
